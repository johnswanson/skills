...
#
# Opt-in: defaults to skip unless `JDS_REVIEW_TALLY_ORCHESTRATOR=1`
...
opt_in="${JDS_REVIEW_TALLY_ORCHESTRATOR:-}"
case "$opt_in" in
    1|true|TRUE|yes|YES|on|ON) ;;
    *)
        echo "orchestrator-tally: skipped (set JDS_REVIEW_TALLY_ORCHESTRATOR=1 to enable; see README §Token counts)"
        exit 0
        ;;
esac
